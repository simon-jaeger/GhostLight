...
export const makeGraphics = new class {
  color(hex: string, width: number, height: number) {
    return new Canvas({
      cache: true,
      width,
      height,
  ...
  scale(img: HTMLImageElement, width: number, height: number) {
    return new Canvas({
      cache: true,
      width,
      height,
  ...
  repeat(img: HTMLImageElement, width: number, height: number) {
    return new Canvas({
      cache: true,
      width,
      height,
